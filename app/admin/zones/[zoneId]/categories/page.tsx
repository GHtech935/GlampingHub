...
import { CategoryFormModal } from "@/components/admin/glamping/CategoryFormModal";
...
export default function CategoriesPage({ params }: { params: Promise<{ zoneId: string }> }) {
  ...
  return (
    <div className="space-y-6">
        ...
        <Tabs value="inventory" className="w-full">
          <div className="flex items-center justify-between mb-4">
            <TabsList>
              ...
              <TabsTrigger
                value="tags"
                onClick={() => router.push(`/admin/zones/${zoneId}/tags`)}
              >
                {t("tabs.tags")}
              </TabsTrigger>
            </TabsList>
      ...
      <div className="flex items-center gap-2">
        <label className="text-sm text-gray-600">{t("filter.label")}</label>
