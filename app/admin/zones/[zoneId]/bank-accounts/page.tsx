...
export default function ZoneBankAccountsPage({ params }: { params: Promise<{ zoneId: string }> }) {
  ...
  const isSpecificZone = zoneId !== "all";
  ...
  const fetchAccounts = async () => {
    ...
    try {
      ...
      // Filter by zone when on a specific zone page
      if (isSpecificZone) {
        params.append("glamping_zone_id", zoneId);
      }
