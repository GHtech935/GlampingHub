                  ...
                  rows.push(
                    <tr key={`${item.itemId}-${item.bookingTentId}-${itemIdx}-header`} className="border-b bg-gray-50">
                      ...
                      <td className="px-3 py-2 text-right w-36">
                        {item.voucherCode && item.discountAmount > 0 ? (
                          <div>
                            <div className="text-sm text-gray-500 line-through">{formatCurrency(item.totalPrice)}</div>
                            <div className="font-medium text-gray-900">{formatCurrency(afterDiscount)}</div>
                          </div>
                        ) : (
