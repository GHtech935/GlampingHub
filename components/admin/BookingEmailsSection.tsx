...
interface BookingEmailsSectionProps {
  bookingId: string;
}

export default function BookingEmailsSection({ bookingId }: BookingEmailsSectionProps) {
  ...
  const fetchEmails = async () => {
    try {
      const response = await fetch(`/api/admin/bookings/${bookingId}/emails`);
      if (response.ok) {
