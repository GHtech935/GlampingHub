/**
 * Email templates for glamping common items updates
 */
...
export const glampingCommonItemsUpdatedCustomerHTML = `
<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Cập nhật dịch vụ chung thành công</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f9fafb;">
  <div style="${emailStyles.container}">
    ...
    <div style="${emailStyles.header}">
      ...
      <p style="color: white; margin: 10px 0 0 0; font-size: 16px;">Cập nhật dịch vụ chung thành công</p>
    </div>
    ...
    <div style="${emailStyles.content}">
      ...
      <div style="background-color: #dcfce7; border-left: 4px solid #22c55e; padding: 15px; margin: 20px 0; border-radius: 4px;">
        <p style="margin: 0; color: #166534; font-size: 16px; font-weight: bold;">
          Đã cập nhật dịch vụ chung thành công!
        </p>
      </div>

      <p style="color: #4b5563; font-size: 15px; line-height: 1.6;">
        Chúng tôi đã nhận được yêu cầu thay đổi dịch vụ chung cho đơn đặt phòng <strong>#{booking_reference}</strong> của bạn.
      </p>
...
export const glampingCommonItemsUpdatedStaffHTML = `
<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Khách cập nhật dịch vụ chung</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f9fafb;">
  <div style="${emailStyles.container}">
    <!-- Header -->
    <div style="background: linear-gradient(135deg, #2563eb 0%, #3b82f6 100%); padding: 20px 15px; text-align: center;">
      ...
      <p style="color: white; margin: 10px 0 0 0; font-size: 16px;">Khách cập nhật dịch vụ chung</p>
    </div>
    ...
    <div style="${emailStyles.content}">
      ...
      <div style="background-color: #dbeafe; border-left: 4px solid #2563eb; padding: 15px; margin: 20px 0; border-radius: 4px;">
        <p style="margin: 0; color: #1e40af; font-size: 16px; font-weight: bold;">
          Khách hàng đã cập nhật dịch vụ chung cho đơn #{booking_reference}
        </p>
      </div>

      <p style="color: #4b5563; font-size: 15px; line-height: 1.6;">
        Khách hàng <strong>{customer_name}</strong> vừa thay đổi dịch vụ chung trong đơn đặt phòng.
      </p>
